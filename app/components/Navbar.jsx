...
const Navbar = () => {
    ...
    return (
        <div className="h-[50px] md:flex bg-gradient-to-r to-black from-[#0b0b3e] shadow-sm shadow-gray-200 text-white items-center align-middle fixed top-0 right-0 left-0 z-40 justify-between md:py-0 py-4  lg:px-24 px-5">
            ...
            <ul onClick={() => setOpen(false)} className="md:hidden transition-all duration-100 fixed h-[calc(100vh-0px)] w-1/2 bg-black top-12 m-0 p-0 font-bold text-gray-300 list-none bottom-0 flex flex-col items-center z-50" style={{ right: open ? "0px" : "-100vw" }}>
                <li className='my-5'>
                    <Link href="/">Home</Link>
                </li>
                <li className='my-5'>
