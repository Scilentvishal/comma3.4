        ...
        <div className="max-w-7xl items-center md:px-3 md:py-3 mx-auto">
          ...
          mx-auto">
            ...
            <div className="md:w-1/2 md:py-6 lg:px-8 md:px-4 px-0">
              <div className="">
                <h3 className='lg:text-4xl text-2xl my-4 font-mono font-black text-[#FE5B7C]'>About Comma Technologies</h3>
                <p>At Comma Technologies, we are passionate about creating innovative web solutions that empower businesses to
                  ...
                  development needs.</p>
                  <button className='font-mono bg-[#FE5B7C] border-l-4 border-black my-4 hover:bg-[#c91e41] text-white font-semibold hover:text-white py-4 px-6 '><Link href="/contact">Contact Us</Link></button>
              </div>
            </div>
          </div>
        </div>
